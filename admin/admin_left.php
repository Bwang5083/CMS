...
<TABLE class=Menu cellSpacing=0>
  <TBODY>
  <TR>
    <TH onClick="javascript:menu_tree('left_3');" align=middle>≡ 用户管理 ≡</TH></TR>
  <TR id=left_3>
    <TD>
      <TABLE width="100%">
        <TBODY>
        <TR>
		  ...
		  <A href="admin_user_list.php" target=main>用户列表</A></TD>
		</TR>
		<TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="admin_main.php" target=main>角色定义</A></TD>
		</TR>
	 </TBODY></TABLE>
	 </TD></TR></TBODY></TABLE>
  ...
  <TR id=left_2>
    <TD>
      <TABLE width="100%">
		...
		<TR>
			<TD><IMG src="images/menu.gif" align=absMiddle border=0>&nbsp;
		  <A href="admin_baidu.php" target=main>百度统计</A></TD>
		</TR>
	 </TBODY></TABLE>
	 </TD></TR></TBODY></TABLE>
